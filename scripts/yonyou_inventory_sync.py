        ...
        transformed.append(
            {
                ...
                "warehouse_code": coalesce(row, ("warehouse_code", "warehouse", "warehouse_id")),
                ...
                "unit_name": coalesce(row, ("product_unitName", "unitName", "stockUnit_name", "unit_name", "unit")),
                "batch_no": coalesce(row, ("batchno", "batch_no")),
                "stock_status_id": coalesce(row, ("stockStatusDoc",)),
                "stock_status_code": coalesce(row, ("stockStatusDoc_code",)),
                "stock_status_name_raw": coalesce(row, ("stockStatusDoc_statusName", "stock_status_name")),
